...
export default function Home() {
  ...
  const findDeals = async (e) => {
    ...
    setDeals([
      ...
      { name: `🏷️ eBay: ${product}`, url: `https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent(product)}` }
    ]);
  };
      ...
      <main className="min-h-screen bg-gray-50 text-gray-900 font-sans">
        ...
        <section id="tools" className="max-w-7xl mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* 3. AI Global Deal Finder (Clickable Links) */}
            <div className="bg-white p-6 rounded-3xl shadow-sm border">
            ...
            {/* 4. Currency */}
            <div className="bg-white p-6 rounded-3xl shadow-sm border">
              <h3 className="font-bold text-xl mb-2 flex items-center gap-2">💱 Real-Time Currency</h3>
            ...
            {/* 5. EMI Calculator */}
            <div className="bg-white p-6 rounded-3xl shadow-sm border">
              <h3 className="font-bold text-xl mb-2 flex items-center gap-2">💳 EMI Calculator</h3>
                ...
                <div key={p.id} className="bg-gray-50 rounded-3xl overflow-hidden shadow-sm border hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
                  ...
                  <div className="p-5 flex-grow flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center mt-4">
                      ...
                      <a href={p.source === 'cj_dropship' ? 'https://paypal.me/AbuHamdan978' : (p.affiliate_link || '#')} target="_blank" className="bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-blue-600 transition">
